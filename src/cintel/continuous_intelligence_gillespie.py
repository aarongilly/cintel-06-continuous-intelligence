...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "system_assessment_gillespie.csv"
...
def main() -> None:
    ...
    def is_error_rate_high(col: pl.Expr) -> pl.Expr:
        return col > MAX_ERROR_RATE

    def is_latency_high(col: pl.Expr) -> pl.Expr:
